...
import org.fintech.domain.config.usecase.VoidUseCaseHandler;
...
public class InstallmentPayUseCaseHandler extends ObservableUseCasePublisher implements VoidUseCaseHandler<InstallmentPayUseCase> {
    ...
    public InstallmentPayUseCaseHandler(InstallmentPort installmentPort, CreditPort creditPort, CachePort cachePort) {
